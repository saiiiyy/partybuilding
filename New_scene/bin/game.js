...
import Script3 from "../28682b28-1752-4f56-9683-adb5a325a285/src/item"
...
const transform4 = new Transform({
  position: new Vector3(9, 0.19509035348892212, 3.519214630126953),
  rotation: new Quaternion(-0.009607374668121338, 0.9903926253318787, -0.09754529595375061, -0.09754518419504166),
  scale: new Vector3(6.000000476837158, 11.999998092651367, 2.250000476837158)
})
...
const transform5 = new Transform({
  position: new Vector3(11, 0, 9.5),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(10, 10, 0.9999998807907104)
})
nftPictureFrame.addComponentOrReplace(transform5)

const galleryInfoDarkGrey = new Entity('galleryInfoDarkGrey')
engine.addEntity(galleryInfoDarkGrey)
galleryInfoDarkGrey.setParent(_scene)
const transform6 = new Transform({
  position: new Vector3(6.5, 0, 10.5),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(1, 1, 1)
})
galleryInfoDarkGrey.addComponentOrReplace(transform6)
...
script3.spawn(galleryInfoDarkGrey, {"text":"test","fontSize":5.5,"font":"SF","color":"#000000"}, createChannel(channelId, galleryInfoDarkGrey, channelBus))